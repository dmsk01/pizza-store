  ...
  return (
    <div className="cart-item">
      ...
      <div className="cart-item__count">
        <div onClick={handleMinusItem} className="count-btn">
          -
        </div>
        <b>{totalCount}</b>
        <div onClick={handlePlusItem} className="count-btn">
          +
        </div>
      </div>
      ...
      <div className="cart-item__remove">
        <Button onClick={handleRemoveClick} className="button_circle" outline>
